                        ...
                        success: function (response) {
                            if (response.trim() != '<b>No brands has been created yet in this category</b>') {
                                ...
                                for (i = 0; i < brand_list.length; i++) {
                                    ...
                                    td_cat.innerHTML = "<select disabled='disabled' class='w-75 border p-2 dynamic-c-name'><option>"+ brand_list[i].category_name +"</option>"+all_option+"</select>";
                                    td_brands.innerHTML =brand_list[i].brands;
                                    
                                    
                                    var td_edit = document.createElement("TD");
                                    td_edit.innerHTML = "<i class='fa fa-edit brand-edit' b-name='"+brand_list[i].brands+"' c-name='"+brand_list[i].category_name+"'></i><i class='fa fa-save d-none brand-save'></i>";

                                    var td_trash = document.createElement("TD");
                                    td_trash.innerHTML = "<i class='fa fa-trash brand-delete' b-name='"+brand_list[i].brands+"' c-name='"+brand_list[i].category_name+"'></i>";
                                 ...
                                 $(".brand-edit").each(function(){
                                     $(this).click(function(){
                                         ...
                                         var selected_tag = td[0].getElementsByClassName('dynamic-c-name')[0];
                                         ...
                                         var edit_icon = td[2].getElementsByClassName("brand-edit")[0];
                            ...
                            {
                                $(".brands_display_area").html('<b>No brands has been created yet in this category</b>'); 
                            }
                        }
